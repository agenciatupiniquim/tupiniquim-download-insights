			...
			<table class="widefat striped">
				...
				<tbody>
					<?php if (! $top_books_raw) : ?>
						<tr>
							<td colspan="3"><?php esc_html_e('Nenhum download registrado no período.', 'book-download-insights'); ?></td>
						</tr>
					<?php endif; ?>
		...
		<div class="bdi-panel">
			...
			<table class="widefat striped">
				...
				<tbody>
					<?php if (! $by_author) : ?>
						<tr>
							<td colspan="2"><?php esc_html_e('Nenhum download registrado no período.', 'book-download-insights'); ?></td>
						</tr>
					<?php endif; ?>
					<?php $count = 0;
	...
	<div class="bdi-panel">
		...
		<table class="widefat striped">
			...
			<tbody>
				<?php if (! $recent) : ?>
					<tr>
						<td colspan="6"><?php esc_html_e('Nenhum download registrado no período.', 'book-download-insights'); ?></td>
					</tr>
				<?php endif; ?>
